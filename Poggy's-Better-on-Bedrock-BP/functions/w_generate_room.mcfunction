...
execute at @s[scores={gen=0}] run function w_generate_rooms
...
execute at @s[scores={gen=2}] run structure load w_end ~0 ~ ~-1
execute at @s[scores={gen=3}] run execute at @s[scores={roomCount=1..}] run scoreboard players add "maxRoomCount" roomCount 1
execute at @s[scores={gen=3}] run structure load ew_connect ~-2 ~ ~-1